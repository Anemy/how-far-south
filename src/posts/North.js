...
export default {
  ...
  content: [
    ...
    'The joy and freedom of bike touring is setting in as we start to drift to sleep in Dosewallip State Park. Our bikes are thawing and we have almost made it further South than Seattle.',
