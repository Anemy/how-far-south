...
mapshaper.runCommands(`-i ./src/scripts/ne_10m_admin_1_states_provinces_lakes/ne_10m_admin_1_states_provinces_lakes.shp ./src/scripts/ne_10m_admin_1_states_provinces_lakes/*.dbf combine-files -o ${directory}/${outputFileName} format=topojson`, err => {
  if (err) {
